...
class DatabaseQuery:
    def __init__(self, host: str, port: int, user: str, password: str,
                 ...
                 site_id: int = 2000, start_date: str = '2025-05-01', end_date: str = '2025-05-01',
...
def work(db_query: DatabaseQuery) -> pd.DataFrame:
    ...
    #场馆 .merge(db_query.mongo(use_date_column=True False), on=['会员ID', '日期'], how='inner')
    ...
    result_df = (db_query._1_member_basic_info()
                 .merge(db_query.mongo_betting_stats(use_date_column=True), on=['会员ID'], how='inner')
                 )
    return result_df
