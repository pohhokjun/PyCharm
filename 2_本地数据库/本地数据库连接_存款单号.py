...
start_time = '2024-06-01 00:00:00'  # 开始时间
end_time = '2024-06-30 23:59:59'    # 结束时间
# site_id = '2000'  # 站点ID

# 使用f-string格式化查询语句
query = f"SELECT * FROM offline_finance_1000.finance_pay_records WHERE pay_status IN (2, 3) AND confirm_at BETWEEN '{start_time}' AND '{end_time}';"
