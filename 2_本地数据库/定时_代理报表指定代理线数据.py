...
folder_path = 'C:/Users/Administrator/Desktop/定时注单导出/代理定时数据/'
...
def export_data_from_database():
    ...
    start_time = '2023-05-31 00:00:00'  # 开始时间
    # --------------------------------------
    ...
    end_time = '2024-06-30 23:59:59'  # 结束时间
    ...
    query = f"""SELECT *
            FROM offline_bigdata.top_daily_report
            WHERE site_id = '{site_id}'
              AND statics_date BETWEEN '{start_time}' AND '{end_time}' 
              AND agent_name IN {tuple(top_list)}
...
# CHAT_ID = '-1002300157208'#测试群
CHAT_ID = '-1002415614868'#测试群2
